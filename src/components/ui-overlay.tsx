    ...
    <>
      ...
      {showInfo && (
        <div className="absolute top-20 left-6 z-20">
          <Card className="w-80 bg-black/30 backdrop-blur-lg border-white/20 shadow-2xl">
            <CardContent className="p-6">
              <h3 className="text-lg font-semibold text-white mb-3">
                About This Globe
              </h3>
              <p className="text-white/90 text-sm leading-relaxed mb-4">
                An interactive 3D Earth visualization powered by React Three
                Fiber. Drag to rotate, scroll to zoom, and explore our beautiful
                planet.
              </p>
      ...
      <div className="absolute bottom-6 left-6 z-10">
        <Card className="bg-black/30 backdrop-blur-lg border-white/20 shadow-xl">
      ...
      <div className="absolute bottom-6 right-6 z-10">
        <Card className="bg-black/30 backdrop-blur-lg border-white/20 shadow-xl">
          <CardContent className="p-4">
            <div className="text-white/90 text-sm text-right space-y-1">
